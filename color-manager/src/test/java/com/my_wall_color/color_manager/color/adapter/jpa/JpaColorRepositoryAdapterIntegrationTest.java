...
class JpaColorRepositoryAdapterIntegrationTest extends IntegrationTest {
  ...
  void shouldReturn3ColorsForJdoeUser() {
    ...
    assertThat(colorsForJdoeUser).isEqualTo(
        List.of(colorFixture.sulyom, colorFixture.havasiGyopar));
  }
  ...
  void shouldReturnFourthAndThirdColor() {
    ...
    assertThat(actual.getContent()).containsExactly(colorFixture.palastfu,
