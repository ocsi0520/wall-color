...
public interface UserRepository {
    ...
    default User requiredById(Integer id) throws NoSuchElementException {
        return findById(id).orElseThrow(() -> new NoSuchElementException("No user was found by id " + id));
    }

    default User requiredByUsername(String username) throws NoSuchElementException {
        return findByUsername(username).orElseThrow(() -> new NoSuchElementException("No user was found with username " + username));
    }
}
